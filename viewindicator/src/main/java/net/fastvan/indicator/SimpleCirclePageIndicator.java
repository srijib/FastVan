 ...
 */
public class SimpleCirclePageIndicator extends View implements PageIndicator {
    ...
    public SimpleCirclePageIndicator(Context context) {
        this(context, null);
    }

    public SimpleCirclePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.vpiCirclePageIndicatorStyle);
    }

    @TargetApi(Build.VERSION_CODES.JELLY_BEAN)
    public SimpleCirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
